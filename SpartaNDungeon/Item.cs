...
namespace SpartaNDungeon
{
    ...
    public class Item
    {
        ...
        {
            new Item("가시 갑옷", ItemType.Armor, 4, "고대의 용사가 입었던 갑옷.", 1000, 0),
            new Item("지배자의 피갑옷", ItemType.Armor, 4, "한 시대를 피로 물들인 폭군의 갑옷.", 1000, 0),
            new Item("망자의 갑옷", ItemType.Armor, 9, "전장에서 쓰러진 병사들의 원혼이 깃든 갑옷.", 2000, 0),
            new Item("심연의 갑옷", ItemType.Armor, 9, "심연 속에서 떠오른 갑옷. 어둠을 두려워하지 않는다면 그것은 그의 것이 된다.", 2000, 0),
            new Item("정령의 형상 갑옷", ItemType.Armor, 15, "잊혀진 전사의 유산. ", 3500, 0),
            new Item("워모그의 갑옷", ItemType.Armor, 15, "워모그, 불사의 거인의 이름을 따 만든 갑옷.", 3500, 0),
            new Item("몰락한 왕의 검", ItemType.Weapon, 5, "한때 왕국을 다스리던 자의 검.", 600, 0),
            new Item("쇼진의 창", ItemType.Weapon, 10, "용을 닮고자 했던 수도원의 유산.", 1500, 0),
            new Item("어둠불꽃 횃불", ItemType.Weapon, 15, "불꽃이 꺼지지 않는 창. 하지만 그 불꽃이 어디서 왔는지는 아무도 모른다.", 2500, 0),
            new Item("공허의 지팡이", ItemType.Weapon, 15, "차원을 넘어온 힘이 깃든 지팡이.", 2500, 0),
            new Item("원칙의 원형낫", ItemType.Weapon, 15, "오직 한 가지 신념만을 따르는 자를 위한 무기", 2500, 0),
            new Item("스태틱의 단검", ItemType.Weapon, 15, "하늘을 가르는 번개, 그리고 그보다 더 빠른 단검", 2500, 0),
            new Item("루난의 허리케인", ItemType.Weapon, 15, "바람을 조종하는 궁수의 유산.", 2500, 0),
