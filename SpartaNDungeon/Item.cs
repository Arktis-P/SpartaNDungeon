        ...
        static List<Item> itemList = new List<Item>
            {
                ...
                new Item("낡은 검", ItemType.Weapon, 5, "쉽게 볼 수 있는 낡은 검입니다.", 600),
                new Item("청동 도끼", ItemType.Weapon, 10, "어디선가 사용됐던 것 같은 도끼입니다.", 1500),
                new Item("스파르타의 창", ItemType.Weapon, 15, "스파르타의 전사들이 사용했다는 전설의 창입니다.", 2500),
                new Item("회복 물약", ItemType.Potion, 30, "체력을 30 회복 할 수 있습니다.", 1000)
            };
